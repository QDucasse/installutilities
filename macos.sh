...
# Disable smart quotes as they’re annoying w hen typing code
...
# Set the icon size of Dock items to 14 pixels
defaults write com.apple.dock tilesize -int 14

# Change minimize/maximize window effect
# Choose between genie suck and scale
